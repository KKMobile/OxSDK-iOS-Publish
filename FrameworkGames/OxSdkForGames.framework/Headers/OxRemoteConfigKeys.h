...
@interface OxRemoteConfigKeys : NSObject
...
extern NSString* const OX_CONFIG_REGEX_CHANNEL;
extern NSString* const OX_CONFIG_REGEX_CAMPAIGN;
extern NSString* const OX_CONFIG_AD_CLICK_UPLOAD;
