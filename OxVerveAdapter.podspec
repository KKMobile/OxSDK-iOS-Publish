#
#  Be sure to run `pod spec lint OxVerveAdapter.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
    ...
    spec.version      = "3.7.1.0"#版本号
    spec.summary      = "OxAdSdkAdapter for Verve applications."#概要
    #描述  （描述一定要比概要多一些,不然会有警告!）
    spec.description  = <<-DESC
    OxAdSdk for Verve applications.OxAdSdk for Verve applications.
                   DESC
    ...
    spec.source       = { :git => "https://github.com/KKMobile/OxSDK-iOS-Publish.git", :tag => "a-verve-#{spec.version}" }
