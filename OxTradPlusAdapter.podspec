#
#  Be sure to run `pod spec lint OxFacebookAdapter.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
    ...
    OxAdSdk for TradPlus applications.OxAdSdk for TradPlus applications.
                   DESC
    ...
    spec.source       = { :git => "https://github.com/KKMobile/OxSDK-iOS-Publish.git", :tag => "a-tradplus-#{spec.version}" }
    spec.frameworks = "UIKit", "Foundation"#SDK依赖的系统库文件
    spec.requires_arc = true#是否时自动内存管理
    spec.pod_target_xcconfig = { 'VALID_ARCHS' => 'x86_64 armv7 arm64'}#支持架构配置
    spec.resource_bundles = {'OxTradPlusAdapter' => ['ResBundle/PrivacyInfo.xcprivacy']}
    spec.ios.vendored_frameworks = 'Frameworks/OxTradPlusAdapter.framework'
    
    spec.dependency 'AppLovinMediationFacebookAdapter', '6.15.2.1'
    spec.dependency 'GoogleMobileAdsMediationFacebook','6.15.2.1'
    
    spec.dependency 'TradPlusAdSDK', '12.5.0'
