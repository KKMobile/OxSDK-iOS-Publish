#
#  Be sure to run `pod spec lint OxInmobiAdapter.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
    ...
    spec.version      = "10.7.5.0"#版本号
    spec.summary      = "OxAdSdkAdapter for Inmobi applications."#概要
    #描述  （描述一定要比概要多一些,不然会有警告!）
    spec.description  = <<-DESC
    OxAdSdk for Inmobi applications.OxAdSdk for Inmobi applications.
                   DESC
