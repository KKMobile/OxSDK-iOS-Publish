#
#  Be sure to run `pod spec lint OxAPSAdapter.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
    ...
    spec.version      = "5.2.0.0"#版本号
    spec.summary      = "OxAdSdkAdapter for APS applications."#概要
    #描述  （描述一定要比概要多一些,不然会有警告!）
    spec.description  = <<-DESC
    OxAdSdk for APS applications.OxAdSdk for APS applications.
                   DESC
    ...
    spec.source       = { :git => "https://github.com/KKMobile/OxSDK-iOS-Publish.git", :tag => "a-aps-#{spec.version}" }
    ...
    spec.dependency 'AmazonPublisherServicesSDK','5.2.0.0'
