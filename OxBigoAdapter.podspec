#
#  Be sure to run `pod spec lint OxBigoAdapter.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
    ...
    OxAdSdk for BIGO applications.OxAdSdk for BIGO applications.
                   DESC
    ...
    spec.source       = { :git => "https://github.com/KKMobile/OxSDK-iOS-Publish.git", :tag => "a-bigo-#{spec.version}" }
