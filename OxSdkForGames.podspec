...
Pod::Spec.new do |spec|
    ...
    spec.version      = "1.1.4.1-RC02-202404151200"#版本号
    ...
    spec.dependency 'AmazonPublisherServicesSDK','4.9.0.0'
    spec.dependency 'AppLovinMediationAmazonAdMarketplaceAdapter','4.9.0.0'
    ...
    spec.dependency 'AppLovinMediationGoogleAdManagerAdapter', '11.2.0.1'
    spec.dependency 'AppLovinMediationGoogleAdapter', '11.2.0.1'
    spec.dependency 'AppLovinMediationInMobiAdapter', '10.7.1.0'
    spec.dependency 'ALInMobiCustomAdapterFramework', '10.7.1.0'
    spec.dependency 'AppLovinMediationIronSourceAdapter', '7.9.1.0.0'
    ...
    spec.dependency 'AppLovinMediationByteDanceAdapter', '5.8.0.8.1'
    ...
    spec.dependency 'GoogleMobileAdsMediationVungle','7.3.0.0'
    spec.dependency 'GoogleMobileAdsMediationChartboost','9.7.0.0'
    spec.dependency 'GoogleMobileAdsMediationInMobi','10.7.1.0'
    spec.dependency 'GoogleMobileAdsMediationPangle','5.8.0.8.0'
    spec.dependency 'GoogleMobileAdsMediationFacebook','6.15.0.0'
    spec.dependency 'GoogleMobileAdsMediationIronSource','7.9.1.0.0'
