...
Pod::Spec.new do |spec|
    ...
    spec.version      = "1.1.4.1-RC02-202404081030"#版本号
    ...
    spec.dependency 'AppLovinMediationIronSourceAdapter', '7.8.0.0.1'
    spec.dependency 'AppLovinMediationFacebookAdapter', '6.15.0.0'
    spec.dependency 'AppLovinMediationMobileFuseAdapter', '1.7.2.0'
    ...
    spec.dependency 'GoogleMobileAdsMediationIronSource','7.8.0.0.0'
    spec.dependency 'GoogleMobileAdsMediationFyber','8.2.6.1'
    ...
    spec.dependency 'MobileFuseAdMobAdapter','1.7.2.0'
