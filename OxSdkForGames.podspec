...
#描述  （描述一定要比概要多一些,不然会有警告!）
  ...
  spec.dependency 'AppLovinMediationHyprMXAdapter','6.3.0.0'
  

  #Admob Mediation
  spec.dependency 'GoogleMobileAdsMediationVungle','7.1.0.0'
  spec.dependency 'GoogleMobileAdsMediationChartboost','9.5.1.0'
  spec.dependency 'GoogleMobileAdsMediationIronSource','7.5.1.0'
  spec.dependency 'MobileFuseAdMobAdapter','1.6.5.0'
  
  spec.dependency 'OxSdkCore','1.2.0.0-RC10-202401101930'
