...
Pod::Spec.new do |spec|
    ...
    spec.version      = "2.0-PR-1340StaImp-202601061800"#版本号
    ...
    spec.dependency 'OxSdkCore', '2.0-PR-1340StaImp-202601061800'
    
    spec.dependency 'OxAPSAdapter', '5.3.3.0'
    spec.dependency 'OxBidMachineAdapter', '3.5.1.0.0'
    spec.dependency 'OxChartboostAdapter', '9.11.0.0'
    spec.dependency 'OxFacebookAdapter', '6.21.0.0'
    spec.dependency 'OxFyberAdapter', '8.4.2.1'
    spec.dependency 'OxInmobiAdapter', '11.0.0.0'
    ...
    spec.dependency 'OxMolocoAdapter', '4.2.0.0'
    spec.dependency 'OxMyTargetAdapter', '5.21.9.0'
    spec.dependency 'OxOguryAdapter', '5.0.1.0'
    spec.dependency 'OxPangleAdapter', '7.8.0.8.0'
    spec.dependency 'OxPubmaticAdapter', '4.11.0.0'
    spec.dependency 'OxSmaatoAdapter', '22.9.3.0'
    spec.dependency 'OxUnityAdsAdapter', '4.16.1.0'
    spec.dependency 'OxVerveAdapter', '3.7.1.0'
    spec.dependency 'OxVungleAdapter', '7.6.2.0'
