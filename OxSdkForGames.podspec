...
Pod::Spec.new do |spec|
  ...
  spec.version      = "1.0.4-patch02-test01"#版本号
...
#描述  （描述一定要比概要多一些,不然会有警告!）
  ...
  spec.pod_target_xcconfig = { 'VALID_ARCHS' => 'x86_64 armv7 arm64'}#支持架构配置
    ...
    spec.dependency 'AppLovinMediationGoogleAdManagerAdapter','9.9.0.1'
    spec.dependency 'AppLovinMediationGoogleAdapter','9.9.0.1'
