#
#  Be sure to run `pod spec lint OxSdkForGamespec.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.version      = "1.1.2.0-RC01-202305091100"#版本号
  spec.summary      = "OxAdSdk for game applicationspec."#概要
#描述  （描述一定要比概要多一些,不然会有警告!）
  spec.description  = <<-DESC
  OxAdSdk for game applicationspec.OxAdSdk for game applicationspec.
                   DESC
  ...
  spec.iospec.deployment_target = "12.0"#支持iOS最低版本
  spec.swift_version = '4.0'
  spec.source       = { :git => "https://github.com/KKMobile/OxSDK-iOS-Publish.git", :tag => "g-#{spec.version}" }
  spec.iospec.vendored_frameworks = 'FrameworkGames/OxSdkForGamespec.framework'#SDK相对本文件路径
  spec.frameworks = "UIKit", "Foundation"#SDK依赖的系统库文件
  spec.requires_arc = true#是否时自动内存管理
  spec.pod_target_xcconfig = { 'VALID_ARCHS' => 'x86_64 armv7 arm64'}#支持架构配置
  spec.resources = ["ResBundle/Games/OxSdkRespec.bundle","ResBundle/Games/Language.bundle"]
    ...
    spec.dependency 'AppLovinMediationBidMachineAdapter', '2.0.0.6.0'
    ...
    #spec.dependency 'GoogleMobileAdsMediationInMobi','10.5.4.0'
    spec.dependency 'GoogleMobileAdsMediationUnity','4.6.1.0'
    #spec.dependency 'GoogleMobileAdsMediationFyber','8.1.9.1'
    #spec.dependency 'GoogleMobileAdsMediationPangle','4.9.1.0.0'
