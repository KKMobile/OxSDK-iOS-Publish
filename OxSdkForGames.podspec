...
Pod::Spec.new do |spec|
  ...
  spec.version      = "1.2.0.0-RC04-202309112130"#版本号
...
#描述  （描述一定要比概要多一些,不然会有警告!）
  ...
  spec.dependency 'AppLovinMediationBidMachineAdapter', '2.3.0.2.0'
  ...
  spec.dependency 'OxSdkCore','1.2.0.0-RC04-202309112130'
