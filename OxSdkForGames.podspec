...
Pod::Spec.new do |spec|
    ...
    spec.version      = "UA-MtgMlc-202605121300"#版本号
    ...
    spec.dependency 'OxSdkCore', '1.3.5.1-RC04-202604222013'
    ...
    spec.dependency 'OxFyberAdapter', '8.4.6.0'
    ...
    spec.dependency 'OxMintegralAdapter', '8.1.3.0.0'
    spec.dependency 'OxMolocoAdapter', '4.5.1 '
