#
#  Be sure to run `pod spec lint OxTAPlugin.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
    ...
    spec.source       = { :git => "https://github.com/KKMobile/OxSDK-iOS-Publish.git", :tag => "a-event-ta-#{spec.version}" }
    spec.frameworks = "UIKit", "Foundation"#SDK依赖的系统库文件
    spec.requires_arc = true#是否时自动内存管理
    spec.pod_target_xcconfig = { 'VALID_ARCHS' => 'x86_64 armv7 arm64'}#支持架构配置
    spec.resource_bundles = {'OxTAPlugin' => ['ResBundle/PrivacyInfo.xcprivacy']}
    spec.source_files  = 'iOS/OxSDK-Game/OxTAPlugin/**/*.{h,m}'
