#
#  Be sure to run `pod spec lint OxRemoteConfigPlugin.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
    ...
    OxAdSdk for Remote applications.OxAdSdk for Remote applications.
                   DESC
    ...
    spec.source       = { :git => "https://github.com/KKMobile/OxSDK-iOS-Publish.git", :tag => "a-remote-#{spec.version}" }
