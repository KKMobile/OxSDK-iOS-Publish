#
#  Be sure to run `pod spec lint OxMintegralAdapter.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
    ...
    spec.version      = "8.1.5.0.2"#版本号
    spec.summary      = "OxAdSdk for Mintegral applications."#概要
    #描述  （描述一定要比概要多一些,不然会有警告!）
    spec.description  = <<-DESC
    OxAdSdk for Mintegral applications.OxAdSdk for Mintegral applications.
                   DESC
    ...
    spec.source       = { :git => "https://github.com/KKMobile/OxSDK-iOS-Publish.git", :tag => "a-mintegral-#{spec.version}" }
    spec.frameworks = "UIKit", "Foundation"#SDK依赖的系统库文件
    spec.requires_arc = true#是否时自动内存管理
    spec.pod_target_xcconfig = { 'VALID_ARCHS' => 'x86_64 armv7 arm64'}#支持架构配置
    spec.resource_bundles = {'OxMintegralAdapter' => ['ResBundle/PrivacyInfo.xcprivacy']}
    ...
    spec.dependency 'GoogleMobileAdsMediationMintegral', '8.1.5.0.0'
end
