...
static NSString * const AdFormat_MREC = @"MAREC";
...
typedef NS_ENUM(NSInteger, OxSdkMediationType) {
    OxSdkMediationType_Admob = 1,
    OxSdkMediationType_Max = 2,
    OxSdkMediationType_Om = 3,
    OxSdkMediationType_None = 9999
};
...
static NSString * const PARAM_OM = @"OM";
