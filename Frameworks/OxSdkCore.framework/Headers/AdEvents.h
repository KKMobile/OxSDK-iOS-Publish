...
static NSString * const EVENT_AD_DYNAMIC_EXPLORE_ACTION = @"Ad_Dynamic_Explore_Action";
...
static NSString * const PARAM_STAGE = @"stage";
static NSString * const PARAM_ACTION_TYPE = @"actionType";
static NSString * const PARAM_TARGET_DYNAMIC_ID = @"targetDynamicId";
static NSString * const PARAM_EXPLORE_ID = @"exploreId";
static NSString * const PARAM_REQUEST_RATIO = @"requestRatio";
