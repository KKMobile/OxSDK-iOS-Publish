...
static NSString * const EVENT_INIT_PANGLE_SDK = @"Init_Pangle_Sdk";
...
static NSString * const EVENT_AD_SHOWING_REASON = @"Ad_Showing_Reason";
...
static NSString * const PARAM_INIT_SDK_IS_INSTALL_WEBVIEW = @"isInstallWebView";
...
static NSString * const PARAM_SHOW_STRATEGY = @"ShowStrategy";
static NSString * const PARAM_SHOW_REASON = @"ShowReason";
static NSString * const PARAM_SHOW_WINNER = @"ShowWinner";
static NSString * const PARAM_READY_CANDIDATES = @"ReadyCandidates";
static NSString * const PARAM_LOST_CANDIDATES = @"LostCandidates";
