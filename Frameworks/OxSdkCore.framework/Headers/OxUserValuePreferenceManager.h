...
- (void)setTargetEcpm:(float)ecpm adUnitId:(NSString *)adUnitId;
- (float)getTargetEcpm:(NSString *)adUnitId;

- (void)setSegmentMapForAdUnitId:(NSString *)adUnitId ecpm:(float)ecpm;
- (NSDictionary *)getSegmentMap:(NSString *)adUnitId;
