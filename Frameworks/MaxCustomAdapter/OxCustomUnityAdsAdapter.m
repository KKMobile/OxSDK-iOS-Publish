...
- (instancetype)initWithParentAdapter:(OxCustomUnityAdsAdapter *)parentAdapter placementIdentifier:(NSString *)placementIdentifier adFormat:(MAAdFormat *)adFormat andNotify:(id<MAAdViewAdapterDelegate>)delegate;
@end
                        ...
                        andNotify:(id<MAAdViewAdapterDelegate>)delegate
{
    ...
    self.adViewDelegate = [[OxCustomUnityAdsAdViewDelegate alloc] initWithParentAdapter: self placementIdentifier: placementIdentifier adFormat: adFormat andNotify: delegate];
