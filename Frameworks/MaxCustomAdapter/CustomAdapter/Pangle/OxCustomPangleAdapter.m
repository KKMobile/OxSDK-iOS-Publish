...
#import "OxCustomPangleAdapter.h"
#import <PAGAdSDK/PAGAdSDK.h>

#define ADAPTER_VERSION @"5.5.0.9.0"

@interface OxCustomPangleInterstitialAdDelegate : NSObject <PAGLInterstitialAdDelegate>
@property (nonatomic,   weak) OxCustomPangleAdapter *parentAdapter;
@property (nonatomic, strong) id<MAInterstitialAdapterDelegate> delegate;
- (instancetype)initWithParentAdapter:(OxCustomPangleAdapter *)parentAdapter andNotify:(id<MAInterstitialAdapterDelegate>)delegate;
@end

@interface OxCustomPangleAppOpenAdDelegate : NSObject <PAGLAppOpenAdDelegate>
@property (nonatomic,   weak) OxCustomPangleAdapter *parentAdapter;
@property (nonatomic, strong) id<MAAppOpenAdapterDelegate> delegate;
- (instancetype)initWithParentAdapter:(OxCustomPangleAdapter *)parentAdapter andNotify:(id<MAAppOpenAdapterDelegate>)delegate;
@end

@interface OxCustomPangleRewardedVideoAdDelegate : NSObject <PAGRewardedAdDelegate>
@property (nonatomic,   weak) OxCustomPangleAdapter *parentAdapter;
@property (nonatomic, strong) id<MARewardedAdapterDelegate> delegate;
@property (nonatomic, assign, getter=hasGrantedReward) BOOL grantedReward;
- (instancetype)initWithParentAdapter:(OxCustomPangleAdapter *)parentAdapter andNotify:(id<MARewardedAdapterDelegate>)delegate;
@end

@interface OxCustomPangleAdViewAdDelegate : NSObject <PAGBannerAdDelegate>
@property (nonatomic,   weak) OxCustomPangleAdapter *parentAdapter;
@property (nonatomic, strong) id<MAAdViewAdapterDelegate> delegate;
- (instancetype)initWithParentAdapter:(OxCustomPangleAdapter *)parentAdapter andNotify:(id<MAAdViewAdapterDelegate>)delegate;
@end

@interface OxCustomPangleNativeAdViewAdDelegate : NSObject <PAGLNativeAdDelegate>
@property (nonatomic,   weak) MAAdFormat *adFormat;
@property (nonatomic,   weak) OxCustomPangleAdapter *parentAdapter;
@property (nonatomic,   copy) NSString *slotId;
@property (nonatomic, strong) NSDictionary<NSString *, id> *serverParameters;
@property (nonatomic, strong) id<MAAdViewAdapterDelegate> delegate;
- (instancetype)initWithParentAdapter:(OxCustomPangleAdapter *)parentAdapter parameters:(id<MAAdapterResponseParameters>)parameters format:(MAAdFormat *)adFormat andNotify:(id<MAAdViewAdapterDelegate>)delegate;
@end

@interface OxCustomPangleNativeAdDelegate : NSObject <PAGLNativeAdDelegate>
@property (nonatomic,   weak) OxCustomPangleAdapter *parentAdapter;
@property (nonatomic,   copy) NSString *slotId;
@property (nonatomic, strong) NSDictionary<NSString *, id> *serverParameters;
@property (nonatomic, strong) id<MANativeAdAdapterDelegate> delegate;
- (instancetype)initWithParentAdapter:(OxCustomPangleAdapter *)parentAdapter parameters:(id<MAAdapterResponseParameters>)parameters andNotify:(id<MANativeAdAdapterDelegate>)delegate;
@end

@interface OxCustomPangle : MANativeAd
@property (nonatomic, weak) OxCustomPangleAdapter *parentAdapter;
- (instancetype)initWithParentAdapter:(OxCustomPangleAdapter *)parentAdapter builderBlock:(NS_NOESCAPE MANativeAdBuilderBlock)builderBlock;
- (instancetype)initWithFormat:(MAAdFormat *)format builderBlock:(NS_NOESCAPE MANativeAdBuilderBlock)builderBlock NS_UNAVAILABLE;
@end

@interface OxCustomPangleAdapter ()

@property (nonatomic, strong) PAGLInterstitialAd *interstitialAd;
@property (nonatomic, strong) OxCustomPangleInterstitialAdDelegate *interstitialAdDelegate;

@property (nonatomic, strong) PAGLAppOpenAd *appOpenAd;
@property (nonatomic, strong) OxCustomPangleAppOpenAdDelegate *appOpenAdDelegate;

@property (nonatomic, strong) PAGRewardedAd *rewardedVideoAd;
@property (nonatomic, strong) OxCustomPangleRewardedVideoAdDelegate *rewardedVideoAdDelegate;

@property (nonatomic, strong) PAGBannerAd *adViewAd;
@property (nonatomic, strong) OxCustomPangleAdViewAdDelegate *adViewAdDelegate;
@property (nonatomic, strong) PAGLNativeAd *nativeAdViewAd;
@property (nonatomic, strong) OxCustomPangleNativeAdViewAdDelegate *nativeAdViewAdDelegate;
@property (nonatomic, strong) PAGLNativeAdRelatedView *nativeAdViewRelatedView;

@property (nonatomic, strong) PAGLNativeAd *nativeAd;
@property (nonatomic, strong) OxCustomPangleNativeAdDelegate *nativeAdDelegate;
@property (nonatomic, strong) PAGLNativeAdRelatedView *nativeAdRelatedView;

@end

@implementation OxCustomPangleAdapter
static NSTimeInterval const kDefaultImageTaskTimeoutSeconds = 10.0;
static ALAtomicBoolean              *OxCustomPangleInitialized;
static MAAdapterInitializationStatus OxCustomPangleInitializationStatus = NSIntegerMin;

+ (void)initialize
{
    [super initialize];
    
    OxCustomPangleInitialized = [[ALAtomicBoolean alloc] init];
}

- (void)initializeWithParameters:(id<MAAdapterInitializationParameters>)parameters completionHandler:(void (^)(MAAdapterInitializationStatus, NSString *_Nullable))completionHandler
{
    if ( [OxCustomPangleInitialized compareAndSet: NO update: YES] )
    {
        OxCustomPangleInitializationStatus = MAAdapterInitializationStatusInitializing;
        ...
        [PAGSdk startWithConfig: configuration completionHandler:^(BOOL success, NSError *error) {
            if ( !success || error )
            {
                ...
                OxCustomPangleInitializationStatus = MAAdapterInitializationStatusInitializedFailure;
                completionHandler(OxCustomPangleInitializationStatus, error.localizedDescription);
                return;
            }
            
            [self log: @"Pangle SDK initialized"];
            
            OxCustomPangleInitializationStatus = MAAdapterInitializationStatusInitializedSuccess;
            completionHandler(OxCustomPangleInitializationStatus, nil);
        }];
    }
    else
    {
...
- (void)loadInterstitialAdForParameters:(id<MAAdapterResponseParameters>)parameters andNotify:(id<MAInterstitialAdapterDelegate>)delegate
{
    ...
    [PAGLInterstitialAd loadAdWithSlotID: slotId
        ...
        if ( error )
        {
            MAAdapterError *adapterError = [OxCustomPangleAdapter toMaxError: error];
        ...
        self.interstitialAdDelegate = [[OxCustomPangleInterstitialAdDelegate alloc] initWithParentAdapter: self andNotify: delegate];
...
- (void)loadAppOpenAdForParameters:(id<MAAdapterResponseParameters>)parameters andNotify:(id<MAAppOpenAdapterDelegate>)delegate
{
    ...
    [PAGLAppOpenAd loadAdWithSlotID: slotId request: request completionHandler:^(PAGLAppOpenAd *_Nullable appOpenAd, NSError *_Nullable error) {
        ...
        self.appOpenAdDelegate = [[OxCustomPangleAppOpenAdDelegate alloc] initWithParentAdapter: self andNotify: delegate];
...
- (void)loadRewardedAdForParameters:(id<MAAdapterResponseParameters>)parameters andNotify:(id<MARewardedAdapterDelegate>)delegate
{
    ...
    [PAGRewardedAd loadAdWithSlotID: slotId
        ...
        self.rewardedVideoAdDelegate = [[OxCustomPangleRewardedVideoAdDelegate alloc] initWithParentAdapter: self andNotify: delegate];
    ...
    dispatchOnMainQueue(^{
        ...
        if ( isNative )
        {
            ...
            [PAGLNativeAd loadAdWithSlotID: slotId request: request completionHandler:^(PAGLNativeAd *_Nullable ad, NSError *_Nullable error) {
                ...
                self.nativeAdViewAdDelegate = [[OxCustomPangleNativeAdViewAdDelegate alloc] initWithParentAdapter: self
        ...
        else
        {
            ...
            [PAGBannerAd loadAdWithSlotID: slotId
                ...
                self.adViewAdDelegate = [[OxCustomPangleAdViewAdDelegate alloc] initWithParentAdapter: self andNotify: delegate];
...
- (void)loadNativeAdForParameters:(id<MAAdapterResponseParameters>)parameters andNotify:(id<MANativeAdAdapterDelegate>)delegate
{
    ...
    dispatchOnMainQueue(^{
        ...
        [PAGLNativeAd loadAdWithSlotID: slotId request: request completionHandler:^(PAGLNativeAd *_Nullable ad, NSError *_Nullable error) {
            ...
            self.nativeAdDelegate = [[OxCustomPangleNativeAdDelegate alloc] initWithParentAdapter: self
                                                                                    parameters: parameters
                                                                                     andNotify: delegate];
            ...
            dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
                ...
                // Currently we aren't rendering dislikeButton
                // If we need it, we need to add it to the subView manually. It is accessible through relatedView
                MANativeAd *maxNativeAd = [[OxCustomPangle alloc] initWithParentAdapter: self builderBlock:^(MANativeAdBuilder *builder) {
                    builder.title = nativeAdData.AdTitle;
                    builder.body = nativeAdData.AdDescription;
                    builder.callToAction = nativeAdData.buttonText;
                    builder.icon = iconImage;
...
@implementation OxCustomPangleInterstitialAdDelegate
...
@implementation OxCustomPangleAppOpenAdDelegate
...
@implementation OxCustomPangleRewardedVideoAdDelegate
...
@implementation OxCustomPangleAdViewAdDelegate
...
@implementation OxCustomPangleNativeAdViewAdDelegate
...
@implementation OxCustomPangleNativeAdDelegate
