...
#define ADAPTER_VERSION @"8.4.4.0"

@interface OxCustomFyberAdapterGlobalDelegate : NSObject <IAGlobalAdDelegate>
@end

@interface OxCustomFyberAdapterInterstitialDelegate : NSObject <IAUnitDelegate, IAVideoContentDelegate, IAMRAIDContentDelegate>
@property (nonatomic,   weak) OxCustomFyberAdapter *parentAdapter;
@property (nonatomic, strong) id<MAInterstitialAdapterDelegate> delegate;
- (instancetype)initWithParentAdapter:(OxCustomFyberAdapter *)parentAdapter andNotify:(id<MAInterstitialAdapterDelegate>)delegate;
@end

@interface OxCustomFyberAdapterRewardedDelegate : NSObject <IAUnitDelegate, IAVideoContentDelegate, IAMRAIDContentDelegate>
@property (nonatomic,   weak) OxCustomFyberAdapter *parentAdapter;
@property (nonatomic, strong) id<MARewardedAdapterDelegate> delegate;
@property (nonatomic, assign, getter=hasGrantedReward) BOOL grantedReward;
- (instancetype)initWithParentAdapter:(OxCustomFyberAdapter *)parentAdapter andNotify:(id<MARewardedAdapterDelegate>)delegate;
@end

@interface OxCustomFyberAdapterAdViewDelegate : NSObject <IAUnitDelegate, IAMRAIDContentDelegate>
@property (nonatomic,   weak) OxCustomFyberAdapter *parentAdapter;
@property (nonatomic, strong) id<MAAdViewAdapterDelegate> delegate;
- (instancetype)initWithParentAdapter:(OxCustomFyberAdapter *)parentAdapter andNotify:(id<MAAdViewAdapterDelegate>)delegate;
@end

@interface OxCustomFyberAdapter ()
...
@property (nonatomic, strong) OxCustomFyberAdapterInterstitialDelegate *interstitialDelegate;
...
@property (nonatomic, strong) OxCustomFyberAdapterRewardedDelegate *rewardedDelegate;

// Ad View
@property (nonatomic, strong) IAAdSpot *adViewAdSpot;
@property (nonatomic, strong) IAViewUnitController *adViewUnitController;
@property (nonatomic, strong) OxCustomFyberAdapterAdViewDelegate *adViewDelegate;
...
@implementation OxCustomFyberAdapter
...
static OxCustomFyberAdapterGlobalDelegate *ALInneractiveGlobalDelegate;
static NSMutableDictionary<NSString *, OxCustomFyberAdapter *> *ALInneractiveCurrentlyShowingAdapters;
...
+ (void)initialize
{
    ...
    ALInneractiveGlobalDelegate = [[OxCustomFyberAdapterGlobalDelegate alloc] init];
...
- (void)initializeWithParameters:(id<MAAdapterInitializationParameters>)parameters completionHandler:(void (^)(MAAdapterInitializationStatus, NSString *_Nullable))completionHandler
{
    @try {
        ...
        NSLog(@"[OxCustomFyberAdapter] %@",exception.reason);
    }
}
...
- (void)loadInterstitialAdForParameters:(id<MAAdapterResponseParameters>)parameters andNotify:(id<MAInterstitialAdapterDelegate>)delegate
{
    ...
    self.interstitialDelegate = [[OxCustomFyberAdapterInterstitialDelegate alloc] initWithParentAdapter: self andNotify: delegate];
    ...
    IAAdSpotAdResponseBlock adResponseBlock = ^(IAAdSpot *_Nullable adSpot, IAAdModel *_Nullable adModel, NSError *_Nullable error) {
        ...
        else
        {
            ...
            [delegate didFailToLoadInterstitialAdWithError: [OxCustomFyberAdapter toMaxError: error]];
        }
    };
...
- (void)loadRewardedAdForParameters:(id<MAAdapterResponseParameters>)parameters andNotify:(id<MARewardedAdapterDelegate>)delegate
{
    ...
    self.rewardedDelegate = [[OxCustomFyberAdapterRewardedDelegate alloc] initWithParentAdapter: self andNotify: delegate];
    ...
    IAAdSpotAdResponseBlock adResponseBlock = ^(IAAdSpot *_Nullable adSpot, IAAdModel *_Nullable adModel, NSError *_Nullable error) {
        ...
        else
        {
            ...
            [delegate didFailToLoadRewardedAdWithError: [OxCustomFyberAdapter toMaxError: error]];
        }
    };
                        ...
                        andNotify:(id<MAAdViewAdapterDelegate>)delegate
{
    ...
    self.adViewDelegate = [[OxCustomFyberAdapterAdViewDelegate alloc] initWithParentAdapter: self andNotify: delegate];
    ...
    IAAdSpotAdResponseBlock adResponseBlock = ^(IAAdSpot *_Nullable adSpot, IAAdModel *_Nullable adModel, NSError *_Nullable error) {
        ...
        else
        {
            ...
            [delegate didFailToLoadAdViewAdWithError: [OxCustomFyberAdapter toMaxError: error]];
        }
    };
...
@implementation OxCustomFyberAdapterInterstitialDelegate
...
@implementation OxCustomFyberAdapterRewardedDelegate
...
@implementation OxCustomFyberAdapterAdViewDelegate
...
@implementation OxCustomFyberAdapterGlobalDelegate
...
- (void)adDidShowWithImpressionData:(IAImpressionData *)impressionData withAdRequest:(IAAdRequest *)adRequest
{
    ...
    OxCustomFyberAdapter *adapter = ALInneractiveCurrentlyShowingAdapters[placementID];
