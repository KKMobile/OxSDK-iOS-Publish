#
#  Be sure to run `pod spec lint OxSmaatoAdapter.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
    ...
    spec.version      = "22.9.0.0"#版本号
    spec.summary      = "OxAdSdkAdapter for Smaato applications."#概要
    #描述  （描述一定要比概要多一些,不然会有警告!）
    spec.description  = <<-DESC
    OxAdSdk for Smaato applications.OxAdSdk for Smaato applications.
                   DESC
    ...
    spec.source       = { :git => "https://github.com/KKMobile/OxSDK-iOS-Publish.git", :tag => "a-smaato-#{spec.version}" }
    spec.frameworks = "UIKit", "Foundation"#SDK依赖的系统库文件
    spec.requires_arc = true#是否时自动内存管理
    spec.pod_target_xcconfig = { 'VALID_ARCHS' => 'x86_64 armv7 arm64'}#支持架构配置
    
    spec.dependency 'AppLovinMediationSmaatoAdapter', '22.9.0.0'
end
