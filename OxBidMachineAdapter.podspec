#
#  Be sure to run `pod spec lint OxBidMachineAdapter.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
    ...
    spec.version      = "3.4.0.0.0"#版本号
    spec.summary      = "OxAdSdkAdapter for BidMachine applications."#概要
    #描述  （描述一定要比概要多一些,不然会有警告!）
    spec.description  = <<-DESC
    OxAdSdk for BidMachine applications.OxAdSdk for BidMachine applications.
                   DESC
    ...
    spec.dependency 'AppLovinMediationBidMachineAdapter', '3.4.0.0.0'
end
