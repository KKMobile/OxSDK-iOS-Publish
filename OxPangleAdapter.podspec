#
#  Be sure to run `pod spec lint OxPangleAdapter.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
    ...
    spec.version      = "8.1.0.9.1"#版本号
    spec.summary      = "OxAdSdk for Pangle applications."#概要
    #描述  （描述一定要比概要多一些,不然会有警告!）
    spec.description  = <<-DESC
    OxAdSdk for Pangle applications.OxAdSdk for Pangle applications.
                   DESC
    ...
    spec.source       = { :git => "https://github.com/KKMobile/OxSDK-iOS-Publish.git", :tag => "a-pangle-#{spec.version}" }
    ...
    spec.dependency 'AppLovinMediationByteDanceAdapter', "8.1.1.1.0"
    spec.dependency 'GoogleMobileAdsMediationPangle', "8.1.1.1.0"  
end
