...
Pod::Spec.new do |spec|
  ...
  spec.version      = "1.0.6-rc01-202210281712"#版本号
  spec.summary      = "OxAdSdk for unity applications."#概要
#描述  （描述一定要比概要多一些,不然会有警告!）
  spec.description  = <<-DESC
  OxAdSdk for unity applications.OxAdSdk for unity applications.
                   DESC
  ...
  spec.source       = { :git => "https://github.com/KKMobile/OxSDK-iOS-Publish.git", :tag => "u-#{spec.version}" }
