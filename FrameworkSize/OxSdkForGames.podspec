...
Pod::Spec.new do |spec|
    ...
    spec.subspec 'OxSdkForGames_Base' do |ss|
      ss.ios.vendored_frameworks = ['OxSdkForGames.framework,OxSdkForGames_Base.framework']#SDK相对本文件路径
    
    end
  
    spec.subspec 'OxSdkForGames_Lite1' do |ss|
        ss.ios.vendored_frameworks = ['OxSdkForGames.framework,OxSdkForGames_Lite1.framework']#SDK相对本文件路径
    ...
    spec.subspec 'OxSdkForGames_Lite2' do |ss|
        ss.ios.vendored_frameworks = ['OxSdkForGames.framework,OxSdkForGames_Lite2.framework']#SDK相对本文件路径
