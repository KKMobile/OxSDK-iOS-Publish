...
/// Initializes OxMediation's SDK with all the ad types that are defined in the platform.
+ (void)initWithAppKey:(NSString*)appKey;

/// Initializes OxMediation's SDK with the requested ad types.
...
/// Check that `OxMediation` has been initialized
+ (BOOL)isInitialized;
...
/// A tool to verify a successful integration of the OxMediation SDK and any additional adapters.
