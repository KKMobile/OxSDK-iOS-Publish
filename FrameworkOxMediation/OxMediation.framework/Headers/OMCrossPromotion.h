...
/// Parameter scene: the value is an NSString, ad scene name in OxMediation dashboard setting.
...
/// @param size  ad size
/// @param angle  Rotated angle in clockwise.
/// @param sceneName  The value is an NSString, ad scene name in OxMediation dashboard setting.
