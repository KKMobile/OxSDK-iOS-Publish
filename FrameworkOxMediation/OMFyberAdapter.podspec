...
Pod::Spec.new do |spec|
  ...
  spec.version      = "7.5.4.0-202211282229"#版本号
  spec.summary      = "This is OMFyberAdapter"#概要
#描述  （描述一定要比概要多一些,不然会有警告!）
  spec.description  = <<-DESC
  This is OMFyberAdapter.This is OMFyberAdapter.
                   DESC
  ...
  spec.source       = { :git => "https://github.com/KKMobile/OxSDK-iOS-Publish.git", :tag => "om-fyber-#{spec.version}" }
  spec.ios.vendored_frameworks = 'FrameworkOxMediation/adapters/OMFyberAdapter.framework'#SDK相对本文件路径
  spec.frameworks = "UIKit", "Foundation"#SDK依赖的系统库文件
  spec.requires_arc = true#是否时自动内存管理
  spec.pod_target_xcconfig = { 'VALID_ARCHS' => 'x86_64 armv7 arm64'}#支持架构配置

  spec.dependency 'Fyber_Marketplace_SDK', '7.5.4'
