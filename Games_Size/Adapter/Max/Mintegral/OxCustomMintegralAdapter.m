//
//  OxCustomMintegralAdapter.m
//  AppLovinSDK
//

#import "OxCustomMintegralAdapter.h"
...
@interface OxCustomMintegralAdapterInterstitialDelegate : NSObject <MTGNewInterstitialAdDelegate, MTGNewInterstitialBidAdDelegate>
@property (nonatomic,   weak) OxCustomMintegralAdapter *parentAdapter;
@property (nonatomic, strong) id<MAInterstitialAdapterDelegate> delegate;
- (instancetype)initWithParentAdapter:(OxCustomMintegralAdapter *)parentAdapter andNotify:(id<MAInterstitialAdapterDelegate>)delegate;
@end

@interface OxCustomMintegralAdapterAppOpenAdDelegate : NSObject <MTGSplashADDelegate>
@property (nonatomic,   weak) OxCustomMintegralAdapter *parentAdapter;
@property (nonatomic, strong) id<MAAppOpenAdapterDelegate> delegate;
- (instancetype)initWithParentAdapter:(OxCustomMintegralAdapter *)parentAdapter andNotify:(id<MAAppOpenAdapterDelegate>)delegate;
@end

@interface OxCustomMintegralAdapterRewardedDelegate : NSObject <MTGRewardAdLoadDelegate, MTGRewardAdShowDelegate>
@property (nonatomic,   weak) OxCustomMintegralAdapter *parentAdapter;
@property (nonatomic, strong) id<MARewardedAdapterDelegate> delegate;
@property (nonatomic, assign, getter=hasGrantedReward) BOOL grantedReward;
- (instancetype)initWithParentAdapter:(OxCustomMintegralAdapter *)parentAdapter andNotify:(id<MARewardedAdapterDelegate>)delegate;
@end

@interface OxCustomMintegralAdapterBannerViewDelegate : NSObject <MTGBannerAdViewDelegate>
@property (nonatomic,   weak) OxCustomMintegralAdapter *parentAdapter;
@property (nonatomic, strong) id<MAAdViewAdapterDelegate> delegate;
- (instancetype)initWithParentAdapter:(OxCustomMintegralAdapter *)parentAdapter andNotify:(id<MAAdViewAdapterDelegate>)delegate;
@end

@interface OxCustomMintegralAdapterNativeAdDelegate : NSObject <MTGNativeAdManagerDelegate, MTGBidNativeAdManagerDelegate, MTGMediaViewDelegate>
@property (nonatomic,   weak) OxCustomMintegralAdapter *parentAdapter;
@property (nonatomic, strong) NSDictionary<NSString *, id> *serverParameters;
@property (nonatomic, strong) id<MANativeAdAdapterDelegate> delegate;
@property (nonatomic, strong) NSString *unitId;
@property (nonatomic, strong) NSString *placementId;
- (instancetype)initWithParentAdapter:(OxCustomMintegralAdapter *)parentAdapter parameters:(id<MAAdapterResponseParameters>)parameters andNotify:(id<MANativeAdAdapterDelegate>)delegate;
@end

@interface OxCustomMintegralAdapterNativeAdViewDelegate : NSObject <MTGNativeAdManagerDelegate, MTGBidNativeAdManagerDelegate, MTGMediaViewDelegate>
@property (nonatomic,   weak) OxCustomMintegralAdapter *parentAdapter;
...
@property (nonatomic, strong) NSString *unitId;
@property (nonatomic, strong) NSString *placementId;
- (instancetype)initWithParentAdapter:(OxCustomMintegralAdapter *)parentAdapter format:(MAAdFormat *)format parameters:(id<MAAdapterResponseParameters>)parameters andNotify:(id<MAAdViewAdapterDelegate>)delegate;
@end

@interface OxCustomMintegralNativeAd : MANativeAd
@property (nonatomic, weak) OxCustomMintegralAdapter *parentAdapter;
- (instancetype)initWithParentAdapter:(OxCustomMintegralAdapter *)parentAdapter adFormat:(MAAdFormat *)format builderBlock:(NS_NOESCAPE MANativeAdBuilderBlock)builderBlock;
- (instancetype)initWithFormat:(MAAdFormat *)format builderBlock:(NS_NOESCAPE MANativeAdBuilderBlock)builderBlock NS_UNAVAILABLE;
@end

@interface OxCustomMintegralAdapter ()
...
@property (nonatomic, strong) OxCustomMintegralAdapterInterstitialDelegate *interstitialDelegate;
@property (nonatomic, strong) OxCustomMintegralAdapterAppOpenAdDelegate *appOpenAdDelegate;
@property (nonatomic, strong) OxCustomMintegralAdapterRewardedDelegate *rewardedDelegate;
@property (nonatomic, strong) OxCustomMintegralAdapterBannerViewDelegate *bannerDelegate;
@property (nonatomic, strong) OxCustomMintegralAdapterNativeAdDelegate *nativeAdDelegate;
@property (nonatomic, strong) OxCustomMintegralAdapterNativeAdViewDelegate *nativeAdViewDelegate;

@end

@implementation OxCustomMintegralAdapter
...
- (void)initializeWithParameters:(id<MAAdapterInitializationParameters>)parameters completionHandler:(void (^)(MAAdapterInitializationStatus, NSString *_Nullable))completionHandler
{
    ...
    NSString *appKey = [parameters.customParameters al_stringForKey: @"app_key"];
    if (!appKey || appKey.length == 0) {
        completionHandler(MAAdapterInitializationStatusDoesNotApply, nil);
        [self log: @"Initializing Mintegral SDK error  with app id: %@ and app key: %@...", appId, appKey];
        return;
    }
...
- (void)loadInterstitialAdForParameters:(id<MAAdapterResponseParameters>)parameters andNotify:(id<MAInterstitialAdapterDelegate>)delegate
{
    ...
    self.interstitialDelegate = [[OxCustomMintegralAdapterInterstitialDelegate alloc] initWithParentAdapter: self andNotify: delegate];
    
    NSString *unitId = parameters.thirdPartyAdPlacementIdentifier;
    NSString *placementId = [parameters.customParameters al_stringForKey: @"placement_id"];
...
- (void)loadAppOpenAdForParameters:(id<MAAdapterResponseParameters>)parameters andNotify:(id<MAAppOpenAdapterDelegate>)delegate
{
    ...
    self.appOpenAdDelegate = [[OxCustomMintegralAdapterAppOpenAdDelegate alloc] initWithParentAdapter: self andNotify: delegate];
...
- (void)loadRewardedAdForParameters:(id<MAAdapterResponseParameters>)parameters andNotify:(id<MARewardedAdapterDelegate>)delegate
{
    ...
    self.rewardedDelegate = [[OxCustomMintegralAdapterRewardedDelegate alloc] initWithParentAdapter: self andNotify: delegate];
                        ...
                        andNotify:(id<MAAdViewAdapterDelegate>)delegate
{
    ...
    if ( isNative )
    {
        self.nativeAdViewDelegate = [[OxCustomMintegralAdapterNativeAdViewDelegate alloc] initWithParentAdapter: self
                                                                                                            format: adFormat
    ...
    else
    {
        ...
        self.bannerDelegate = [[OxCustomMintegralAdapterBannerViewDelegate alloc] initWithParentAdapter: self andNotify: delegate];
...
- (void)loadNativeAdForParameters:(id<MAAdapterResponseParameters>)parameters andNotify:(id<MANativeAdAdapterDelegate>)delegate
{
    ...
    self.nativeAdDelegate = [[OxCustomMintegralAdapterNativeAdDelegate alloc] initWithParentAdapter: self
                                                                                            parameters: parameters
                                                                                             andNotify: delegate];
...
@implementation OxCustomMintegralAdapterInterstitialDelegate
...
- (void)newInterstitialAdLoadFail:(NSError *)error adManager:(MTGNewInterstitialAdManager *)adManager
{
    ...
    MAAdapterError *adapterError = [OxCustomMintegralAdapter toMaxError: error];
...
@implementation OxCustomMintegralAdapterAppOpenAdDelegate
...
@implementation OxCustomMintegralAdapterRewardedDelegate
...
@implementation  OxCustomMintegralAdapterBannerViewDelegate
...
@implementation OxCustomMintegralAdapterNativeAdViewDelegate
...
- (void)nativeAdsLoaded:(NSArray *)nativeAds bidNativeManager:(MTGBidNativeAdManager *)bidNativeManager
{
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        dispatchOnMainQueue(^{
            ...
            MANativeAd *maxNativeAdViewAd = [[OxCustomMintegralNativeAd alloc] initWithParentAdapter: self.parentAdapter adFormat: self.format builderBlock:^(MANativeAdBuilder *builder) {
...
@implementation OxCustomMintegralAdapterNativeAdDelegate
...
- (void)processNativeAd:(MTGCampaign *)campaign unitId:(NSString *)unitId
{
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        dispatchOnMainQueue(^{
            ...
            MANativeAd *maxNativeAd = [[OxCustomMintegralNativeAd alloc] initWithParentAdapter: self.parentAdapter adFormat: MAAdFormat.native builderBlock:^(MANativeAdBuilder *builder) {
                builder.title = campaign.appName;
                builder.body = campaign.appDesc;
                builder.callToAction = campaign.adCall;
                builder.icon = iconImage;
...
@implementation OxCustomMintegralNativeAd
